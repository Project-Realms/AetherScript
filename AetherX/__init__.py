...
class Parser:
	...
	def expr(self):
		...
		node = res.register(self.bin_op(
			self.comp_expr, ((ttkeyword, 'And'), (ttkeyword, 'Or'))))
	...
	def comp_expr(self):
		...
		node = res.register(self.bin_op(
			self.arith_expr, (ttee, ttne, ttlt, ttgt, ttlte, ttgte)))
...
class BuiltInFunction(BaseFunction):
	...
	def execute_run(self, exec_ctx):
		...
		_, error = create_instance(fn, script)
